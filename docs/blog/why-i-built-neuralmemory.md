...
Everything is async Python. Storage is pluggable (SQLite default, in-memory for testing). The MCP server exposes 60 tools that any AI assistant can call.

### Numbers

- **1,649 tests** passing
- **60 MCP tools** (remember, recall, context, train, conflicts, health, habits, ...)
