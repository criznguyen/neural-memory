...
Persistent memory for AI agents — 59 MCP tools, spreading activation recall, neuroscience-inspired consolidation.
...
- **59 MCP tools** — remember, recall, consolidate, review, visualize, and more
