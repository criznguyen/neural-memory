...
3. `READ gitnexus://repo/Neural Memory/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Neural Memory/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Neural Memory/clusters` | All functional areas |
| `gitnexus://repo/Neural Memory/processes` | All execution flows |
| `gitnexus://repo/Neural Memory/process/{name}` | Step-by-step execution trace |
