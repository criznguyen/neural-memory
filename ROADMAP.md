...
**Current state**: v4.31.0 — 60 MCP tools, 7100+ tests, schema v39, SQLite + PostgreSQL + InfinityDB backends, neuroscience engine (10 brain-inspired algorithms), tiered memory (HOT/WARM/COLD + auto-tier + domain boundaries), decision intelligence, 7-module handler architecture, Pro bundled in main package (license-gated), Brain Store community marketplace (GitHub-backed).
